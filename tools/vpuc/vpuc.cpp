//===-- vpuc.cpp - Implement the VpuSim Native Code Generator -------------===//
//
// This is the vpuc code generator driver. It provides a convenient
...
// General options for vpuc.  Other pass-specific options are specified
...
int main(int argc, char **argv) {
  ...
  // Initialize codegen and IR passes used by vpuc so that the -print-after,
  ...
  cl::ParseCommandLineOptions(argc, argv, "VpuSim compiler\n");
